            ...
            },
            {
              ...
              value: function (t) {
                ...
                if ((M.attr("index", a), m && M.attr({ "clip-path": "url(#gridRectMask".concat(A.globals.cuid, ")") }), "none" !== A.config.states.normal.filter.type)) S.getDefaultFilter(M, a)
                  ...
                  k &&
                  (!A.config.chart.dropShadow.enabledOnSeries || (A.config.chart.dropShadow.enabledOnSeries && -1 !== A.config.chart.dropShadow.enabledOnSeries.indexOf(a)))
                ) {
            ...
            },
            {
              ...
              value: function (t, e, i) {
                return (
                  ...
                  e.annotations &&
                    (e.annotations.yaxis && (e = t.extendYAxisAnnotations(e)), e.annotations.xaxis && (e = t.extendXAxisAnnotations(e)), e.annotations.points && (e = t.extendPointAnnotations(e))),
                  e
                )
              },
            },
        ...
        a(t, [
          ...
          },
          {
            ...
            value: function (t, e, i) {
              ...
              return (
                h.indexOf("rgb") > -1 && (h = f.rgb2hex(h)), a.indexOf("rgb") > -1 && (a = f.rgb2hex(a)), n.drawGradient(l, h, a, c, d, r.size, s.fill.gradient.stops, s.fill.gradient.colorStops, i)
              )
            },
          },
        ]),
          ...
          },
          {
            ...
            value: function (t, e, i, a) {
              var s,
                ...
                c = new b(this.ctx)
              if (
                ((n.globals.markers.size[e] > 0 || r) && (h = c.group({ class: r ? "" : "apexcharts-series-markers" })).attr("clip-path", "url(#gridRectMarkerMask".concat(n.globals.cuid, ")")),
                Array.isArray(l.x))
              )
          ...
          },
          {
            ...
            value: function (t, e, i, a, s, r, n) {
              ...
              if (
                ("circle" === m.shape
                  ? (o = f.drawCircle(i))
                  : ("square" !== m.shape && "rect" !== m.shape) || (o = f.drawRect(0, 0, m.width - m.pointStrokeWidth / 2, m.height - m.pointStrokeWidth / 2, m.pRadius)),
          ...
          },
          {
            ...
            value: function (t) {
              ...
              if (!(Array.isArray(e.config.dataLabels.enabledOnSeries) && e.config.dataLabels.enabledOnSeries.indexOf(r) < 0)) {
                ...
                f && (p = this.dataLabelsCorrection(a, s, o, r, n, u, parseInt(d.style.fontSize, 10))),
                  e.globals.zoomed || ((a = p.x), (s = p.y)),
                  p.textRects && (a < -10 - p.textRects.width || a > e.globals.gridWidth + p.textRects.width + 10) && (o = "")
                var m = e.globals.dataLabels.style.colors[r]
                ;((("bar" === e.config.chart.type || "rangeBar" === e.config.chart.type) && e.config.plotOptions.bar.distributed) || e.config.dataLabels.distributed) &&
                  (m = e.globals.dataLabels.style.colors[n]),
                  "function" == typeof m && (m = m({ series: e.globals.series, seriesIndex: r, dataPointIndex: n, w: e })),
                  g && (m = g)
                var v = d.offsetX,
                  y = d.offsetY
        ...
        a(t, [
          ...
          },
          {
            ...
            value: function (t) {
              ...
              return (
                e.config.chart.stacked || (h < 0 ? (h = h + l.width + c) : h + l.width / 2 > e.globals.gridWidth && (h = e.globals.gridWidth - l.width - c)),
            ...
            value: function (t) {
              ...
              if (i.length > 0)
                for (var a = 0; a < i.length; a++) {
                  for (
                    var s = e.globals.dom.baseEl.querySelectorAll(".apexcharts-".concat(t, "-series .apexcharts-series[data\\:realIndex='").concat(a, "'] circle")), r = [], n = 0;
                    n < s.length;
                    n++
                  )
            ...
            value: function (t, e, i, a, s) {
              ...
              if ((t.config.chart.stacked && i.length > 1 && a !== this.barCtx.radiusOnSeriesNumber && (n = 0), this.barCtx.isHorizontal)) {
                ...
                if ((Math.abs(e.x1 - e.x2) < n && (n = Math.abs(e.x1 - e.x2)), void 0 !== i[a][s] || null !== i[a][s])) {
                  ...
                  h && (n *= -1),
                    (l -= n),
                    (o =
                      r.quadraticCurve(l + n, e.barYPosition, l + n, e.barYPosition + (h ? -1 * n : n)) +
                      r.line(l + n, e.barYPosition + e.barHeight - e.strokeWidth - (h ? -1 * n : n)) +
                      r.quadraticCurve(l + n, e.barYPosition + e.barHeight - e.strokeWidth, l, e.barYPosition + e.barHeight - e.strokeWidth))
                }
              ...
              if ((Math.abs(e.y1 - e.y2) < n && (n = Math.abs(e.y1 - e.y2)), void 0 !== i[a][s] || null !== i[a][s])) {
                ...
                g && (n *= -1),
                  (d += n),
                  (c =
                    r.quadraticCurve(e.barXPosition, d - n, e.barXPosition + (g ? -1 * n : n), d - n) +
                    r.line(e.barXPosition + e.barWidth - e.strokeWidth - (g ? -1 * n : n), d - n) +
                    r.quadraticCurve(e.barXPosition + e.barWidth - e.strokeWidth, d - n, e.barXPosition + e.barWidth - e.strokeWidth, d))
              }
            ...
            value: function (t) {
              ...
              a =
                void 0 === this.series[d][g] || null === this.series[d][g]
                  ? n
                  : n - this.series[d][g] / this.yRatio[this.yaxisIndex] + 2 * (this.isReversed ? this.series[d][g] / this.yRatio[this.yaxisIndex] : 0)
        ...
        a(t, [
          ...
          },
          {
            ...
            value: function (t, e) {
              ...
              return (e = (e = (e = (e = (e = e.replace(new RegExp(n[0], "g"), n[A])).replace(new RegExp(o[0], "g"), o[A])).replace(new RegExp(s[0], "g"), s[c])).replace(
                new RegExp(r[0], "g"),
                r[c]
              )).replace(/\\(.)/g, "$1"))
            },
          ...
          },
          {
            ...
            value: function (t) {
              ...
              "function" == typeof g && (c = g(c, u)),
                Number.isFinite(s) && Number.isFinite(r) && ((o = s), (l = r), n.config.series[i].data[a].x && (h = n.config.series[i].data[a].x + ":"), "function" == typeof d && (h = d(h, u)))
              var f = "",
                p = "",
            ...
            value: function () {
              return {
                ...
                xaxis: {
                  ...
                  crosshairs: { width: "barWidth", position: "back", fill: { type: "gradient" }, dropShadow: { enabled: !1 }, stroke: { width: 0 } },
                },
              }
            },
          },
        ...
        a(i, [
          {
            ...
            value: function (e) {
              ...
              if (a && "object" === t(a)) {
                ...
                ;(l =
                  -1 !==
                  ["line", "area", "bar", "candlestick", "boxPlot", "rangeBar", "histogram", "bubble", "scatter", "heatmap", "treemap", "pie", "polarArea", "donut", "radar", "radialBar"].indexOf(
                    a.chart.type
                  )
                    ? r[a.chart.type]()
                    : r.line()),
          ...
          },
          {
            ...
            value: function (t, e) {
              ...
              for (var n = 0; n < t[e].data.length; n++)
                void 0 !== t[e].data[n].y &&
                  (Array.isArray(t[e].data[n].y) ? this.twoDSeries.push(f.parseNumber(t[e].data[n].y[t[e].data[n].y.length - 1])) : this.twoDSeries.push(f.parseNumber(t[e].data[n].y)))
                      ...
                      t.y.forEach(function (e, i) {
                        for (var a = 0; a < t.y.length; a++)
                          if (i !== a) {
                            ...
                            s <= t.y[a].y2 &&
                              n <= r &&
                              (t.overlaps.indexOf(e.rangeName) < 0 && t.overlaps.push(e.rangeName), t.overlaps.indexOf(t.y[a].rangeName) < 0 && t.overlaps.push(t.y[a].rangeName))
                          }
                      })
                    })
                }),
              ...
              if ("array" === t)
                if ((s && 6 === e[i].data[0].length) || (!s && 5 === e[i].data[0].length))
                  for (var c = 0; c < e[i].data.length; c++)
                    r.push(e[i].data[c][1]),
                      n.push(e[i].data[c][2]),
                      s ? (o.push(e[i].data[c][3]), l.push(e[i].data[c][4]), h.push(e[i].data[c][5])) : (l.push(e[i].data[c][3]), h.push(e[i].data[c][4]))
                else
                  for (var d = 0; d < e[i].data.length; d++)
                    Array.isArray(e[i].data[d][1]) &&
                      (r.push(e[i].data[d][1][0]),
                      n.push(e[i].data[d][1][1]),
                      s ? (o.push(e[i].data[d][1][2]), l.push(e[i].data[d][1][3]), h.push(e[i].data[d][1][4])) : (l.push(e[i].data[d][1][2]), h.push(e[i].data[d][1][3])))
              else if ("xy" === t)
                for (var g = 0; g < e[i].data.length; g++)
                  Array.isArray(e[i].data[g].y) &&
                    (r.push(e[i].data[g].y[0]),
                    n.push(e[i].data[g].y[1]),
                    s ? (o.push(e[i].data[g].y[2]), l.push(e[i].data[g].y[3]), h.push(e[i].data[g].y[4])) : (l.push(e[i].data[g].y[2]), h.push(e[i].data[g].y[3])))
          ...
          },
          {
            ...
            value: function (t) {
              ...
              for (
                ...
                if (
                  (("rangeBar" !== a.chart.type && "rangeArea" !== a.chart.type && "rangeBar" !== t[l].type && "rangeArea" !== t[l].type) || ((s.isRangeData = !0), this.handleRangeData(t, l)),
                  this.isMultiFormat())
                )
            ...
            value: function (t) {
              ...
              return new Promise(function (i) {
                ...
                if (window.canvg && f.isIE11()) {
                  var h = window.canvg.Canvg.fromString(o, l, { ignoreClear: !0, ignoreDimensions: !0 })
                  h.start()
                  var c = r.msToBlob()
                  h.stop(), i({ blob: c })
                } else {
                        ...
                        if ((o.length && 0 === e && l.push(o.join(a)), t.data && t.data.length))
                          for (var s = 0; s < t.data.length; s++) {
                            ...
                            if ((r || (c.isFormatXY() ? (r = i[e].data[s].x) : c.isFormat2DArray() && (r = i[e].data[s] ? i[e].data[s][0] : "")), 0 === e)) {
                              o.push(
                                ((d = r), "datetime" === n.config.xaxis.type && String(d).length >= 10 ? n.config.chart.toolbar.export.csv.dateFormatter(r) : f.isNumber(r) ? r : r.split(a).join(""))
                              )
                            ...
                            ;("candlestick" === n.config.chart.type || (t.type && "candlestick" === t.type)) &&
                              ...
                              ("boxPlot" === n.config.chart.type || (t.type && "boxPlot" === t.type)) &&
                                (o.pop(),
          ...
          },
          {
            ...
            value: function (t) {
              ...
              ;(0 === e && l.globals.skipFirstTimelinelabel) ||
                ...
                (l.config.grid.xaxis.lines.show && this._drawGridLine({ x1: i, y1: a, x2: s, y2: r, parent: o }), new _(this.ctx).drawXaxisTicks(i, this.elg))
            },
          },
          {
            key: "_drawGridLine",
            ...
            value: function (t) {
              ...
              if (s.config.grid.yaxis.lines.show) {
                ...
                for (var g = 0; g < d + (this.isTimelineBar ? 1 : 0); g++)
                  this._drawGridLine({ x1: 0, y1: l, x2: c, y2: h, parent: this.elgridLinesH }), (h = l += s.globals.gridHeight / (this.isTimelineBar ? d : a))
              }
            },
          },
          {
                    ...
                    ? (void 0 !== c[d][g] && (n = Math.max(n, c[d][g])),
                      ...
                      ("candlestick" !== this.w.config.chart.type && "boxPlot" !== this.w.config.chart.type) ||
                        (void 0 !== r.seriesCandleC[d][g] &&
                          ...
                          "boxPlot" === this.w.config.chart.type && (n = Math.max(n, r.seriesCandleM[d][g]))),
                        !s.series[d].type || ("candlestick" === s.series[d].type && "boxPlot" === s.series[d].type) || ((n = Math.max(n, r.series[d][g])), (e = Math.min(e, r.series[d][g]))),
                        (i = n)),
          ...
          },
          {
            ...
            value: function () {
              ...
              if (
                ...
                var n = t.maxY - i
                ;((i >= 0 && i <= 10) || void 0 !== e.yaxis[0].min || void 0 !== e.yaxis[0].max) && (n = 0),
                  (t.minY = i - (5 * n) / 100),
              ...
              if (
                (e.yaxis.forEach(function (e, i) {
                  void 0 !== e.max &&
                    ("number" == typeof e.max ? (t.maxYArr[i] = e.max) : "function" == typeof e.max && (t.maxYArr[i] = e.max(t.isMultipleYAxis ? t.maxYArr[i] : t.maxY)), (t.maxY = t.maxYArr[i])),
                    void 0 !== e.min &&
                      ("number" == typeof e.min
                        ? (t.minYArr[i] = e.min)
                        : "function" == typeof e.min && (t.minYArr[i] = e.min(t.isMultipleYAxis ? (t.minYArr[i] === Number.MIN_VALUE ? 0 : t.minYArr[i]) : t.minY)),
                      (t.minY = t.minYArr[i]))
                }),
                t.isBarHorizontal)
              ) {
      ...
      function t(i) {
        ...
        ;(this.isColorFn = !1),
          (this.isHeatmapDistributed =
            ("treemap" === a.config.chart.type && a.config.plotOptions.treemap.distributed) || ("heatmap" === a.config.chart.type && a.config.plotOptions.heatmap.distributed)),
                    ...
                    Array.isArray(e.config.colors) &&
                      ...
                      (e.globals.colors = e.config.series.map(function (i, a) {
                        ...
                        return (
                          ...
                          "function" == typeof s
                            ? ((t.isColorFn = !0),
                              s({ value: e.globals.axisCharts ? (e.globals.series[a][0] ? e.globals.series[a][0] : 0) : e.globals.series[a], seriesIndex: a, dataPointIndex: a, w: e }))
                            : s
                        )
                      }))),
        ...
        a(t, [
          ...
          },
          {
            ...
            value: function () {
              ...
              return (
                1.05 * (t = new b(this.dCtx.ctx).getTextRects(a, e.config.xaxis.labels.style.fontSize)).width * i.length > e.globals.gridWidth &&
                  0 !== e.config.xaxis.labels.rotate &&
                    ...
                    (function (t) {
                      if (e.dCtx.timescaleLabels && e.dCtx.timescaleLabels.length) {
                        ...
                        l > a.svgWidth - a.translateX - c && (a.skipLastTimelinelabel = !0),
                          h < -((t.show && !t.floating) || ("bar" !== s.chart.type && "candlestick" !== s.chart.type && "rangeBar" !== s.chart.type && "boxPlot" !== s.chart.type) ? 10 : n / 1.75) &&
                ...
                e.config.yaxis.map(function (r, n) {
                  ...
                  if (!s.isYAxisHidden(n) && r.labels.show && o.result.length) {
                    ...
                    if (((void 0 !== d && 0 !== d.length) || (d = c), e.globals.isBarHorizontal)) {
                      ...
                      ;(d = l((d = f.getLargestStringFromArr(u)), { seriesIndex: n, dataPointIndex: -1, w: e })), (g = t.dCtx.dimHelpers.getLargestStringFromMultiArr(d, u))
                    }
                    var p = new b(t.dCtx.ctx),
                      ...
                      v = m
                    d !== g && (v = p.getTextRects(g, r.labels.style.fontSize, r.labels.style.fontFamily, x, !1)),
                      i.push({ width: (v.width > m.width ? v.width : m.width) + a, height: v.height > m.height ? v.height : m.height })
            ...
            value: function (t) {
              ...
              if (
                ...
                l <= 3 && (l = e.globals.dataPoints),
                  ...
                  o > t / 2 && (o /= 2),
                  (s = ((o / r) * parseInt(e.config.plotOptions.bar.columnWidth, 10)) / 100) < 1 && (s = 1),
                  (s = s / (r > 1 ? 1 : 1.5) + 5),
          ...
          },
          {
            ...
            value: function () {
              ...
              if (!i.legend.show || i.legend.floating)
                return (
                  (e.gridHeight = e.svgHeight - i.grid.padding.left + i.grid.padding.right), (e.gridWidth = e.gridHeight), (e.translateY = r), void (e.translateX = n + (e.svgWidth - e.gridWidth) / 2)
                )
            ...
            value: function (t) {
                ...
                if (
                  (a.config.yaxis[i] &&
                    ...
                    a.globals.ancillaryCollapsedSeriesIndices.indexOf(i) < 0 &&
                      (a.globals.ancillaryCollapsedSeries.push({ index: i, data: s[i].data.slice(), type: e.parentNode.className.baseVal.split("-")[1] }),
              ...
              for (var o = e.childNodes, l = 0; l < o.length; l++)
                o[l].classList.contains("apexcharts-series-markers-wrap") &&
                  (o[l].classList.contains("apexcharts-hide") ? o[l].classList.remove("apexcharts-hide") : o[l].classList.add("apexcharts-hide"))
            ...
            value: function (t) {
              ...
              return (
                ...
                r.globals.isXNumeric &&
                  ((m = (v = this.closestInMultiArray(g, u, y, b)).index), (p = v.j), null !== m && ((y = r.globals.seriesXvalues[m]), (p = (v = this.closestInArray(g, y)).index))),
            ...
            value: function (t) {
              ...
              if (
                (e.globals.isXNumeric
                  ? ((n -= a % 2 != 0 ? l / 2 : 0),
                    r && (r.classList.contains("apexcharts-candlestick-area") || r.classList.contains("apexcharts-boxPlot-area")) && e.globals.comboCharts && (n -= l / 2))
                  : e.globals.isBarHorizontal || ((n = i.xAxisTicksPositions[t - 1] + i.dataPointsDividedWidth / 2), isNaN(n) && (n = i.xAxisTicksPositions[t] - i.dataPointsDividedWidth / 2)),
          ...
          },
          {
            ...
            value: function (t, e, i, a) {
              ...
              r.hoverX < 0 || r.hoverX > s.globals.gridWidth
                ...
                : (this.tooltipUtil.isXoverlap(n) || s.globals.isBarHorizontal) && this.create(t, this, 0, n, a.ttItems)
            },
          },
          {
      ...
      return (
        a(s, [
          ...
          },
          {
            ...
            value: function (t) {
              for (
                var e, i = t.indexes, a = t.barHeight, s = t.strokeWidth, r = t.zeroW, n = t.x, o = t.y, l = t.yDivision, h = t.elSeries, c = this.w, d = o, g = i.i, u = i.j, f = 0, p = 0;
            ...
            value: function (t, e, i) {
              ...
              r.distributed || "heatmap" !== t || ((h = a.globals.minY), (c = a.globals.maxY)),
                void 0 !== r.colorScale.min &&
                  ((h = r.colorScale.min < a.globals.minY ? r.colorScale.min : a.globals.minY), (c = r.colorScale.max > a.globals.maxY ? r.colorScale.max : a.globals.maxY))
              ...
              for (var d = 0; d < t.length; d++) {
                ...
                "pie" === this.chartType || "polarArea" === this.chartType
                  ...
                  : "donut" === this.chartType &&
                    (w = f.polarToCartesian(this.centerX, this.centerY, (i.globals.radialSize + this.donutSize) / 2 + i.config.plotOptions.pie.dataLabels.offset, (o + u / 2) % this.fullAngle)),
                  g.add(v)
                var k = 0
                if (
                  ...
                  if (0 !== u && i.config.plotOptions.pie.dataLabels.minAngleToShowLabel < t[d]) {
                    ...
                    I.node.classList.add("apexcharts-pie-label"),
                      i.config.chart.animations.animate &&
                        !1 === i.globals.resized &&
                        (I.node.classList.add("apexcharts-pie-label-delay"), (I.node.style.animationDelay = i.config.chart.animations.speed / 940 + "s")),
            ...
            value: function (t) {
              ...
              for (var m = p ? t.series.length - 1 : 0; p ? m >= 0 : m < t.series.length; p ? m-- : m++) {
                ...
                !this.initialAnim ||
                  ...
                  e.globals.dataChanged &&
                    ((M = ((S - w) / 360) * e.config.chart.animations.dynamicAnimation.speed), (this.animDur = M / (1.2 * t.series.length) + this.animDur), this.animBeginArr.push(this.animDur)),
                  this.animatePaths(z, {
                    centerX: t.centerX,
                    centerY: t.centerY,
                    endAngle: S,
            ...
            value: function (t) {
              ...
              if (r.config.stroke.show && !this.pointsChart) {
                ...
                for (var f = 0; f < s.linePaths.length; f++) {
                  var p = o.renderPaths(
                    n(n({}, h), {}, { pathFrom: s.pathFromLine, pathTo: s.linePaths[f], stroke: u, strokeWidth: this.strokeWidth, strokeLineCap: r.config.stroke.lineCap, fill: "none" })
                  )
                  this.elSeries.add(p)
                }
              }
                  ...
                  n.forEach(function (r, n) {
                    ...
                    if (i.globals.dataChanged) {
                      ...
                      e.dynamicAnim.enabled &&
                        ...
                        i.globals.previousPaths[o] && i.globals.previousPaths[o][n] && i.globals.previousPaths[o][n].rect && (b = i.globals.previousPaths[o][n].rect),
        ...
        a(t, [
          {
            ...
            value: function (t, e) {
              ...
              this.determineInterval(r),
                ...
                r < 0.00011574074074074075 ? (a.globals.disableZoomIn = !0) : r > 5e4 && (a.globals.disableZoomOut = !0)
          ...
          },
          {
            ...
            value: function (t) {
              for (
                ...
                d >= 60 && ((d = 0), 24 === (x += 1) && (x = 0)),
                  this.timeScaleArray.push({ position: b, value: d, unit: "minute", hour: x, minute: d, day: g, year: this._getYear(p, u, 0), month: f.monthMod(u) }),
                  (b += l),
                  d++
            },
          },
            ...
            value: function (t) {
              for (
                ...
                c >= 60 && ((c = 0), ++d >= 60 && ((d = 0), 24 === ++x && (x = 0))),
                  this.timeScaleArray.push({ position: b, value: c, unit: "second", hour: x, minute: d, second: c, day: g, year: this._getYear(p, u, 0), month: f.monthMod(u) }),
                  (b += l),
                  c++
            },
          },
        ...
        a.extend(a.Color, {
          ...
          at: function (t) {
            return this.destination
              ? ((t = t < 0 ? 0 : t > 1 ? 1 : t),
                new a.Color({ r: ~~(this.r + (this.destination.r - this.r) * t), g: ~~(this.g + (this.destination.g - this.g) * t), b: ~~(this.b + (this.destination.b - this.b) * t) }))
              : this
          },
        }),
              ...
              return new Promise(function (s, r) {
                ...
                if (
                  ...
                  if (
                    ...
                    a.globals.axisCharts && (a.globals.isXNumeric || a.config.xaxis.convertedCatToNumeric || a.globals.isTimelineBar))
                  )
